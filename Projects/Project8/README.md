...
Click the architecture diagram below to view the complete project architecture.

[![Complete Project Architecture](architecture/architecture.png)](architecture/architecture.png)
...
-   Creating metadata using AWS Glue Crawlers
