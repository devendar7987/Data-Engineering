...
- [team_home_with_most_goals.sql](team_home_with_most_goals.sql)
- [team_with_majority_possession.sql](team_with_majority_possession.sql)
- [team_won_duel_lost_game_stage_wise.sql](team_won_duel_lost_game_stage_wise.sql)

---

### 🔹 Result Files (CSV Outputs)

- [team_home_with_most_goals.csv](team_home_with_most_goals.csv)
- [team_with_majority_possession.csv](team_with_majority_possession.csv)
- [team_won_duel_lost_game_stage_wise.csv](team_won_duel_lost_game_stage_wise.csv)
