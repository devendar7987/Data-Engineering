...
- most_popular_transport_types.sql → most_popular_transport_types.csv
- emirates_airline_popularity.sql → emirates_airline_popularity.csv
- least_popular_years_tube.sql → least_popular_years_tube.csv
